...
GENERATE_BINARY_PATH = '/code/bin/host'
VALIDATE_BINARY_PATH = '/code/bin/verifier'
...
def generate_and_verify_zkproof(request):
	if request.method == "GET":
		try:
			...
			json_file_path = os.path.join(settings.BASE_DIR, 'user.json')  # Temporary JSON file path
